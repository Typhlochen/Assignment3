...
enum EntityType { PLATFORM, PLAYER, ENEMY, WIN_PLATFORM, BACKGROUND, START_PLATFORM};
...
public:
    ...
    bool      const get_win() const { return m_is_win; }
    ...
    void const set_win(bool winning) { m_is_win = winning; }
